1 REM Modified for 6502 Badge rkincaid 2021
1000 PRINT "THE KINGDOM OF EUPHORIA"
1010 PRINT
1015 DEF FNR(N)=INT(RND(0)*N)
1020 GOSUB 3510
...
2270 GOSUB 3270
2280 GOTO 2220
2310 IF F<=40*P THEN LET S=INT(P-F/40)
2320 LET J=J+S
2330 LET X=5+FNR(4)
...
2380 GOTO 2350
2390 IF FNR(99)<25 THEN LET E=(G+L-F+C)/10
2400 REM WAR AND PLAGUE
2410 IF FNR(99)>15 THEN GOTO 2880
2420 LET W=25
...
2570 IF FNR(99)<W THEN GOTO 2610
...
2690 LET U=-(A+T)/2
2710 LET Z=-D/2
2720 IF R>FNR(99) THEN GOTO 2760
2730 PRINT "YOU HAVE LOST THE WAR"
2740 LET J=INT(J+5000/W)
2750 GOTO 2810
...
2870 LET H=N*80
2880 LET N=P-S-K-M
2890 IF FNR(99)>4 THEN GOTO 2940
2910 PRINT "THE BLACK PLAGUE STRIKES"
2920 LET V=N/2
2930 GOTO 2970
2940 IF FNR(99)>20 THEN GOTO 2980
2950 PRINT "A POX EPIDEMIC BREAKS OUT"
2960 LET V=N/20
2970 LET N=N-V
2980 LET B=INT((N*FNR(5)+9)/100+1)
2990 LET D=INT((N*FNR(3)+4)/100)
