1 REM Modified for the 6502 Badge - rkincaid 2021
5 PRINT TAB(33);"CRAPS"
10 PRINT TAB(15);"CREATIVE COMPUTING  MORRISTOWN, NEW JERSEY"
12 PRINT:PRINT:PRINT
15 LET R=0
19 PRINT"2,3,12 ARE LOSERS; 4,5,6,8,9,10 ARE POINTS; ";
...
40 LET E=INT(6*RND(0)+1)
41 LET S=INT(6*RND(0)+1)
42 LET X=E+S
43 PRINT E" +"S" IS";
50 IF X=7 THEN 180 
55 IF X=11 THEN 180
...
210 LET R= R+F
211 GOTO 320
220 PRINT X " AND IS NOW THE POINT TO MATCH. I WILL ROLL AGAIN"
230 LET H=INT(6*RND(0)+1)
231 LET Q=INT(6*RND(0)+1)
232 LET O=H+Q
240 IF O=1 THEN 230
250 IF O=7 THEN 290
255 IF O=0 THEN 230
...
312 LET F=2*F
313 GOTO 210
320 PRINT " DO YOU WANT TO PLAY AGAIN YES/NO";
330 INPUT M$:M$=UCASE$(M$)
331 IF R<0 THEN 334
332 IF R>0 THEN 336
333 IF R=0 THEN 338
